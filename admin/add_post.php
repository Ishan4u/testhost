...
if(isset($_POST['submit'])){
   ...
   $add_post = $conn->prepare("INSERT INTO `post`(id, admin_id, title, fees, description, thumb, status) VALUES(?,?,?,?,?,?,?)");
   $add_post->execute([$id, $admin_id, $title, $fees, $description, $rename, $status]);

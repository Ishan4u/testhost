...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_admin = $conn->prepare("INSERT INTO `admin`(id, name, profession, email, contact, location, password, image) VALUES(?,?,?,?,?,?,?,?)");
         $insert_admin->execute([$id, $name, $profession, $email, $contact, $location, $cpass, $rename]);
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <input type="text" name="profession" placeholder="eneter your profession" maxlength="50" required class="box">
            <p>your email <span>*</span></p>
            <input type="email" name="email" placeholder="enter your email" maxlength="50" required class="box">
            <p>your contact no <span>*</span></p>
            <input type="text" name="contact" placeholder="enter your contact no" maxlength="50" required class="box">

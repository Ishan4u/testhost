   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <input type="text" name="contact" placeholder="eneter your contact no" maxlength="50" required class="box">
            <p>your location <span>*</span></p>
            <input type="text" name="location" placeholder="eneter your location" maxlength="50" required class="box">
            </div>
